...
class DocVersionsAnalysis200ResponseRestrictionsItem extends JsonSerializableType
{
    /**
    ...
    /**
     * @var value-of<DocVersionsAnalysis200ResponseRestrictionsItemSource> $source
     */
    #[JsonProperty('source')]
     ...
     *   signatureIndex: int,
     *   revisionIndex: int,
     *   source: value-of<DocVersionsAnalysis200ResponseRestrictionsItemSource>,
     *   own: bool,
     *   permission?: ?float,
     *   fields?: mixed,
     * } $values
