...
class DocSignaturesComplete200ResponseMetaCacheDelta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var array<DocSignaturesComplete200ResponseMetaCacheDeltaPagesItem> $pages
     */
    #[JsonProperty('pages'), ArrayType([DocSignaturesComplete200ResponseMetaCacheDeltaPagesItem::class])]
    public array $pages;
     ...
     *   docVersion: int,
     *   pages: array<DocSignaturesComplete200ResponseMetaCacheDeltaPagesItem>,
