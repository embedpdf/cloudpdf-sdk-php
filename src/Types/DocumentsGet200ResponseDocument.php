...
class DocumentsGet200ResponseDocument extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<DocumentsGet200ResponseDocumentState> $state
     */
    #[JsonProperty('state')]
    public string $state;
    ...
    /**
     * @var ?value-of<DocumentsGet200ResponseDocumentThumbnailState> $thumbnailState
     */
     ...
     *   id: string,
     *   tenantId: string,
     *   state: value-of<DocumentsGet200ResponseDocumentState>,
     *   createdAt: float,
     *   updatedAt: float,
     *   baseSha?: ?string,
     ...
     *   thumbnailState?: ?value-of<DocumentsGet200ResponseDocumentThumbnailState>,
     *   thumbnailUrl?: ?string,
     *   createdBy?: ?string,
     * } $values
     */
