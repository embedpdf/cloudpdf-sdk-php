...
class DocumentsInit200ResponseResumedDocument extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<DocumentsInit200ResponseResumedDocumentState> $state
     */
    #[JsonProperty('state')]
    public string $state;
    ...
    /**
     * @var ?value-of<DocumentsInit200ResponseResumedDocumentThumbnailState> $thumbnailState
     */
     ...
     *   id: string,
     *   tenantId: string,
     *   state: value-of<DocumentsInit200ResponseResumedDocumentState>,
     *   createdAt: float,
     *   updatedAt: float,
     *   baseSha?: ?string,
     ...
     *   thumbnailState?: ?value-of<DocumentsInit200ResponseResumedDocumentThumbnailState>,
     *   thumbnailUrl?: ?string,
     *   createdBy?: ?string,
     * } $values
     */
