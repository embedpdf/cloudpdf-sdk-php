...
class DocAnnotationsFlatten200ResponseMetaCacheDelta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var array<DocAnnotationsFlatten200ResponseMetaCacheDeltaPagesItem> $pages
     */
    #[JsonProperty('pages'), ArrayType([DocAnnotationsFlatten200ResponseMetaCacheDeltaPagesItem::class])]
    public array $pages;
     ...
     *   docVersion: int,
     *   pages: array<DocAnnotationsFlatten200ResponseMetaCacheDeltaPagesItem>,
