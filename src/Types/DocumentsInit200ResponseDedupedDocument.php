...
class DocumentsInit200ResponseDedupedDocument extends JsonSerializableType
{
    /**
     * @var string $id
     */
    ...
    /**
     * @var value-of<DocumentsInit200ResponseDedupedDocumentState> $state
     */
    #[JsonProperty('state')]
    public string $state;
    ...
    /**
     * @var ?value-of<DocumentsInit200ResponseDedupedDocumentThumbnailState> $thumbnailState
     */
     ...
     *   id: string,
     *   tenantId: string,
     *   state: value-of<DocumentsInit200ResponseDedupedDocumentState>,
     *   createdAt: float,
     *   updatedAt: float,
     *   baseSha?: ?string,
     ...
     *   thumbnailState?: ?value-of<DocumentsInit200ResponseDedupedDocumentThumbnailState>,
     *   thumbnailUrl?: ?string,
     *   createdBy?: ?string,
     * } $values
     */
