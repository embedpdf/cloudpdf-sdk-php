...
class DocPagesSetName200ResponseMetaCacheDelta extends JsonSerializableType
{
    /**
    ...
    /**
     * @var array<DocPagesSetName200ResponseMetaCacheDeltaPagesItem> $pages
     */
    #[JsonProperty('pages'), ArrayType([DocPagesSetName200ResponseMetaCacheDeltaPagesItem::class])]
    public array $pages;
     ...
     *   docVersion: int,
     *   pages: array<DocPagesSetName200ResponseMetaCacheDeltaPagesItem>,
